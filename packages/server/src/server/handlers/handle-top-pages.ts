...
export const handleTopPages = async (app: AppContext, ctx: HttpContext): Promise<void> => {
  ...
  const rawRows = await app.db.queryTopPaths(propertyId, range.fromMs, range.toMsExclusive, limit);
